...
$(document).ready(function () {
    ...
    grid = $('#grid').grid({
        ...
        minWidth: 560,
        columns: [
            { field: 'SP_Ma', title: "Mã", width: 40, sortable: true },
            { field: 'Anh', tmpl: '<img src="/img/home/sanpham/{Anh}" class="" height="40" alt="product" >', width: 50, height: 30, align: 'left' },
            { field: 'Ten', title: "Tên", width: 200, sortable: true },
            { field: 'category', title: "Loại", width: 160, renderer: function (value, record) {
                let s = '';
                value.forEach(function (element, index) {
                    s += element.Ten;
                    if (value.length !== index+1) s+= ', ';
                    else s += ' ';
                });
                return s; 
                } 
            },
            { field: 'SoLuong', title: "Só lượng", width: 80, priority: 1, align: 'center' },
            { field: 'DonGia', title: "Đơn giá", width: 70, priority: 1 },
            { field: 'GiamGia', title: "Giảm giá", width: 60, priority: 2 },
            { field: 'TrangThai', title: "Trạng thái", width: 60, align: 'center', priority: 4 },
            { field: 'DonVi', title: "Đơn vị", width: 60, align: 'center', priority: 5 },
        ],
    });
